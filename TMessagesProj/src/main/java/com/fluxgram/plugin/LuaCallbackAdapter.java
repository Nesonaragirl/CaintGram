...
/**
 * Adapts a Lua function value into a Java FluxCallback so plugin scripts
 * can be passed anywhere the real Flux API expects a callback
 ...
 * break the Flux code that invoked it.
 */
final class LuaCallbackAdapter implements FluxCallback {

    private static final String TAG = "Flux.Plugin";
